...
mnist = sklearn.datasets.load_breast_cancer()

# Split the data into a training set and a test set

X_train, X_test, y_train, y_test = train_test_split(
    mnist.data / 255., mnist.target, train_size=400, test_size=169, random_state=0)
...
svc = svm.SVC(kernel='linear', C=2.82842712475, gamma=0.00728932024638)
